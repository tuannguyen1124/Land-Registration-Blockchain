        ...
        <>
          ...
          <Row>
            <Col md="12">
              <FormGroup>
                <label>Name</label>
                <Input disabled type="text" value={seller[0]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                <label>Age</label>
                <Input disabled type="text" value={seller[1]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={seller[2]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={seller[3]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={seller[4]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
