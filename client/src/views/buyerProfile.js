...
class buyerProfile extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      var buyer_verify = await this.state.LandInstance.methods
      ...
      buyer = await this.state.LandInstance.methods
        .getBuyerDetails(currentAddress)
        .call();
      console.log(buyer);
      console.log(buyer[0]);
        ...
        <>
          ...
          <Row>
            <Col md="12">
              <FormGroup>
                <label>Name</label>
                <Input disabled type="text" value={buyer[0]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                <label>Age</label>
                <Input disabled type="text" value={buyer[5]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={buyer[4]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                <label>City</label>
                <Input disabled type="text" value={buyer[1]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={buyer[6]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
            <Col md="12">
              <FormGroup>
                ...
                <Input disabled type="text" value={buyer[2]} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
              ...
              <FormGroup>
                ...
                <div class="post-meta">
                  <span class="timestamp">
                    {" "}
                    <a
                      href={`https://ipfs.io/ipfs/${buyer[3]}`}
                      target="_blank"
                    >
                      Here
                    </a>
