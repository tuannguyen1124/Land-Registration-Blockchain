...
function sendMail(email, name) {
  ...
  window.emailjs
    .send("service_vrxa1ak", "template_zhc8m9h", tempParams)
    .then(function (res) {
...
class BuyerInfo extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      var buyersCount = await this.state.LandInstance.methods
        .getBuyersCount()
        .call();
      ...
      var verified = await this.state.LandInstance.methods
      ...
      for (let i = 0; i < buyersCount; i++) {
        ...
        buyerTable.push(
          <tr>
            ...
            <td>{buyer[2]}</td>
            <td>
              <a href={`https://ipfs.io/ipfs/${buyer[3]}`} target="_blank">
                Click Here
              </a>
            </td>
